...
<div class="container body">
    ...
    <div class="main_container">
        @include('layouts.partials.admin.left-panel')
...
<script type="text/javascript" src="{{asset('gentelella/js/jquery.min.js')}}"></script>
<script type="text/javascript" src="{{asset('gentelella/js/bootstrap.min.js')}}"></script>
